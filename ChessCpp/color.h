...
/*
* This header is taken from the open repository https://github.com/aafulei/color-console
* Objectif is to integrate several colors on the console messages to differentiate the pieces of each color.
* Alos, it helps to pass important messages to players.
*/
